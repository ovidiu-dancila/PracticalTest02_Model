    ...
    public void run() {
        ...
        try {
            ...
            if (data.containsKey(city)) {
                ...
                HttpPost httpPost = new HttpPost(Constants.WEB_SERVICE_ADDRESS2);
...
//                HttpGet httpGet = new HttpGet("https://www.wunderground.com/cgi-bin/findweather/getForecast?query=Bucharest");
